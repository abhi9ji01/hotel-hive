      ...
      <section className="text-center my-16 " id="about">
        ...
        <div className="text-gray-500  mx-auto mt-4 flex flex-col gap-4">
          <p>
            ...
            committed to serving you delicious, healthy meals made from the
            freshest ingredients. Our menu features a variety of wholesome
            dishes that are designed to satisfy every palate, from classic
            favorites to innovative creations.
          </p>
          <p>
            We believe in the importance of hygiene and maintain the highest
            cleanliness standards throughout our kitchen and dining areas. This
            ensures that you can enjoy your meal in a safe and welcoming
            environment.
          </p>
          <p>
            Whether you&apos;re a vegetarian, a health enthusiast, or simply
            looking for a delightful dining experience, we invite you to join us
            at HotelHive. Come and taste the difference today.
          </p>
        </div>
      </section>
      <section className="" id="contact">
        <div className="col-span-2 sm:col-span-3  ">
          <h6 className="text-sm font-bold tracking-widest text-gray-900 uppercase font-pj">
            Never miss a delicious deal—subscribe now!{" "}
          </h6>
